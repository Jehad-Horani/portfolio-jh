...
export default function Hero() {
    ...
    return (
        ...
        >
            ...
            <h1
                className="mt-6 text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-pink-500 drop-shadow-lg"
                style={{
